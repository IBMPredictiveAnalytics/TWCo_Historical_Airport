...
#requestType has two value c("geocode","stationId", "postalCode")
...
retriveDataFromTWC <- function(modelerDataRecord){
  ...
  if(input_requestType == "geocode"){
    sLocationUrl = paste("geocode/", 
                         modelerDataRecord[input_latitude],"/", 
                         modelerDataRecord[input_longitude], 
                         sep="")
...
valWx_phrase <- c(fieldName="wx_phrase",fieldLabel="",fieldStorage="real",fieldMeasure="",fieldFormat="",  fieldRole="")
valPressure_tend <- c(fieldName="pressure_tend",fieldLabel="",fieldStorage="real",fieldMeasure="",fieldFormat="",  fieldRole="")
valPressure_desc <- c(fieldName="pressure_desc",fieldLabel="",fieldStorage="real",fieldMeasure="",fieldFormat="",  fieldRole="")
...
valQualifier <- c(fieldName="qualifier",fieldLabel="",fieldStorage="real",fieldMeasure="",fieldFormat="",  fieldRole="")
valQualifier_svrty <- c(fieldName="qualifier_svrty",fieldLabel="",fieldStorage="real",fieldMeasure="",fieldFormat="",  fieldRole="")
valBlunt_phrase <- c(fieldName="blunt_phrase",fieldLabel="",fieldStorage="real",fieldMeasure="",fieldFormat="",  fieldRole="")
valTerse_phrase <- c(fieldName="terse_phrase",fieldLabel="",fieldStorage="real",fieldMeasure="",fieldFormat="",  fieldRole="")
